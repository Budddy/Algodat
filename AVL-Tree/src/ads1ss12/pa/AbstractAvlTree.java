...
public abstract class AbstractAvlTree {
	...
	/**
	 * Der Wurzel-Knoten des AVL-Baums. Bei einem leeren Baum gilt <code>root == null</code>.
	 */
	 ...
	 * 
	 * Der Verweis auf die {@link #root Wurzel} des neuen Baumes wird auf <code>null</code> gesetzt.
	 */
	...
	final protected void inorder(AvlNode n, ArrayList<AvlNode> io) {
		...
		this.inorder(n.left, io);
		
		io.add(n);
		
		this.inorder(n.right, io);
	}
	 ...
	 * 
	 * <p>
	 * Nach der Einf&uuml;geoperation muss nat&uuml;rlich wieder ein korrekter AVL-Baum vorliegen.
	 * </p>
	 * 
	 * <p>
