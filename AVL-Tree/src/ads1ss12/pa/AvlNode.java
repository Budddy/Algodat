 ...
 * 
 * <p>
 * Die Felder der Klasse ({@link #left}, {@link #right}, {@link #balance} und {@link #key}) k&ouml;nnen alle direkt
 * angesprochen werden.
 * </p>
 * 
 * <p>
...
public class AvlNode {
	 ...
	 * 
	 * <p>
	 * <b>WICHTIG:</b> Sie k&ouml;nnen diese Variable beliebig setzen. Das Framework &uuml;berpr&uuml;ft den Wert
	 * <b>nicht</b>!
	 * </p>
	 */
	public int		balance;
	 ...
	 * 
	 * Der neue Knoten hat den Schl&uuml;ssel <code>k</code> und jeweils einen <code>null</code>-Verweis als linkes und
	 * rechtes Kind.
	 * 
	 * @param k
